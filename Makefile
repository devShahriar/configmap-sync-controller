...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name configmap-sync-controller-builder
	$(CONTAINER_TOOL) buildx use configmap-sync-controller-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm configmap-sync-controller-builder
	rm Dockerfile.cross
